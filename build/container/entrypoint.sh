...
# EpistemicTypes.jl container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping EpistemicTypes.jl..."
...
echo "Starting EpistemicTypes.jl..."
echo "  Host: ${APP_HOST:-[::]}"
echo "  Port: ${APP_PORT:-9443}"
...
# Examples:
#   exec /app/EpistemicTypes.jl
#   exec /app/release/bin/EpistemicTypes.jl start
#   exec /app/EpistemicTypes.jl serve --host "${APP_HOST}" --port "${APP_PORT}"
