...
project := "EpistemicTypes.jl"
OWNER := "hyperpolymath"
REPO := "EpistemicTypes.jl"
version := "0.1.0"
...
info:
    @echo "Project: epistemictypes.jl"
...
build *args:
    @echo "Building epistemictypes.jl (debug)..."
...
build-release *args:
    @echo "Building epistemictypes.jl (release)..."
...
install: build-release
    @echo "Installing epistemictypes.jl..."
...
cookbook:
    ...
    echo "= epistemictypes.jl Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/epistemictypes.jl.1 << EOF
    .TH epistemictypes.jl 1 "$(date +%Y-%m-%d)" "{{version}}" "epistemictypes.jl Manual"
    .SH NAME
    epistemictypes.jl \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/epistemictypes.jl.1"
...
doctor:
    @echo "Running diagnostics for EpistemicTypes.jl..."
...
help-me:
    @echo "=== EpistemicTypes.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/EpistemicTypes.jl/issues/new"
    @echo ""
