...
Developers working *on* `EpistemicTypes.jl`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/EpistemicTypes.jl.git
...
* Bugs in `EpistemicTypes.jl`: file at `hyperpolymath/EpistemicTypes.jl/issues`.
