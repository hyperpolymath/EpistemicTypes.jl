...
// Replace EpistemicTypes.jl, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= EpistemicTypes.jl — Quick Start for Users
:toc:
:toclevels: 2

== What is EpistemicTypes.jl?
...
[source,bash]
----
just install --portable --prefix=./EpistemicTypes.jl-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/EpistemicTypes.jl/wiki
