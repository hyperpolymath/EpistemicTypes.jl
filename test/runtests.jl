# EpistemicTypes — test entry point (julia-library archetype)
#
...
@testset "EpistemicTypes — Aqua package shape" begin
    using Aqua
    Aqua.test_all(EpistemicTypes)
end

@testset "EpistemicTypes — behaviour" begin
