...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/EpistemicTypes.jl/security/advisories/new)
...
- This repository (`hyperpolymath/EpistemicTypes.jl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/EpistemicTypes.jl/security/advisories)
...
When using EpistemicTypes.jl, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/EpistemicTypes.jl/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/EpistemicTypes.jl/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/EpistemicTypes.jl/discussions) |
...
*Thank you for helping keep EpistemicTypes.jl and its users safe.* 🛡️
